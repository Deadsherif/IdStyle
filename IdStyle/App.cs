...
namespace IdStyle
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            //Buttons
            #region Buttons
            PushButton button = panel.AddItem(new PushButtonData("IdStyle", "IdStyle", thisassemblypath, "IdStyle.Command")) as PushButton;
            ...
            //Create Styles objects to fill in combo box 
        ...
        public RibbonPanel ribbonpanel(UIControlledApplication a)
        {
            ...
            try
            {
                ...
                RibbonPanel panel = a.CreateRibbonPanel(tab, "IdStyle");
            }
            catch { }
